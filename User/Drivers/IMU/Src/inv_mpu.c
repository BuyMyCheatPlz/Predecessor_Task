...
#include "i2c.h"
#define i2c_write(a, b, c, d)   ((HAL_I2C_Mem_Write(&hi2c1, (uint16_t)((a) << 1), (uint8_t)(b), I2C_MEMADD_SIZE_8BIT, (uint8_t *)(d), (uint16_t)(c), HAL_MAX_DELAY) == HAL_OK) ? 0 : -1)
#define i2c_read(a, b, c, d)    ((HAL_I2C_Mem_Read(&hi2c1, (uint16_t)((a) << 1), (uint8_t)(b), I2C_MEMADD_SIZE_8BIT, (uint8_t *)(d), (uint16_t)(c), HAL_MAX_DELAY) == HAL_OK) ? 0 : -1)
